...
public class CatmullRomSpline : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        if (controlPointsList.Length < 4) return;
    ...
    Vector3 p0_n, p1_n, p2_n, p3_n;
    public Vector3 GetNextCatmullRomPosition(ref int pIndex, ref float u)
    {
        ...
        {
            u = 0.0f;
            pIndex = ClampListPos(pIndex + 1);
        }

        p0_n = controlPointsList[ClampListPos(pIndex - 1)].position;
        p1_n = controlPointsList[pIndex].position;
        p2_n = controlPointsList[ClampListPos(pIndex + 1)].position;
        p3_n = controlPointsList[ClampListPos(pIndex + 2)].position;

        //Find the coordinate between the end points with a Catmull-Rom spline
        return GetCatmullRomPosition(u, p0_n, p1_n, p2_n, p3_n);
